...
public:
    ...
    void imageCallback(const sensor_msgs::ImageConstPtr & msg){
        ...
        cout<<"Corner detected : "<<prev_corner.size()<<endl;
        ...
        cout<<"Corner kept after filtering : "<<prev_corner.size()<<endl;
        ...
        cout<<"Matrice de Transformation "<<endl;
        cout<<T<<endl;

        // Publie la vitesse de defilement
        geometry_msgs::Twist twist;
        cout<<"Vx =  "<<T.at<double>(0,2)<<endl;
        cout<<"Vy =  "<<T.at<double>(1,2)<<endl;
...
int main(int argc, char *argv[]){  
    ...
    cout<<"Starting Optical Flow Node"<<endl;
